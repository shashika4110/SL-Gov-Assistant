export const governmentServices = [
  {
    ...
    "requiredDocuments": [
      {
        "en": "Original National Identity Card (NIC)",
        "si": "මුල් ජාතික හැඳුනුම්පත (NIC)",
        "ta": "அசல் தேசிய அடையாள அட்டை (NIC)"
      },
      {
        "en": "Birth Certificate (for first-time applicants)",
        "si": "උපතේ සහතිකය (පළමු වරට අයදුම්කරුවන් සඳහා)",
        "ta": "பிறப்பு சான்றிதழ் (முதல் முறை விண்ணப்பதாரர்களுக்கு)"
      },
      {
        "en": "Previous passport (for renewal)",
        "si": "පෙර ගමන් බලපත්‍රය (අලුත් කිරීම සඳහා)",
        "ta": "முந்தைய கடவுச்சீடு (புதுப்பிப்புக்கு)"
      },
      {
        "en": "Two recent passport-size photographs (white background)",
        "si": "මෑතකදී ගත් ගමන් බලපත්‍ර ප්‍රමාණයේ ඡායාරූප 2ක් (සුදු පසුබිම)",
        "ta": "சமீபத்திய கடவுச்சீட்டு அளவு புகைப்படங்கள் 2 (வெள்ளை பின்னணி)"
      },
      {
        "en": "Proof of address (utility bill or bank statement)",
        "si": "ලිපිනය සනාථ කිරීම (උපයෝගිතා බිල්පත හෝ බැංකු ප්‍රකාශය)",
        "ta": "முகவரி சான்று (பொது பில் அல்லது வங்கி அறிக்கை)"
      }
    ],
    "steps": [
      {
      ...
      },
      {
        "title": {
          "en": "Book Appointment",
          "si": "වේලාවක් වෙන්කර ගන්න",
          "ta": "நேரம் பதிவு செய்யவும்"
        },
        "description": {
      ...
      },
      {
        "title": {
          "en": "Collect Passport",
          "si": "ගමන් බලපත්‍රය ලබා ගන්න",
          "ta": "கடவுச்சீட்டு பெறவும்"
        },
        "description": {
    ...
    "importantNotes": [
      {
        "en": "Passport must be valid for at least 6 months for most international travel.",
        "si": "බොහෝ ජාත්‍යන්තර ගමන් සඳහා ගමන් බලපත්‍රය අවම වශයෙන් මාස 6ක් වලංගු විය යුය.",
        "ta": "பெரும்பாலான சர்வதேச பயணங்களுக்கு கடவுச்சீடு குறைந்தது 6 மாதங்கள் செல்லுபடியாக வேண்டும்."
      },
      {
        "en": "Damaged or lost passports must be reported immediately to the police and Immigration Department.",
        "si": "හානි වූ හෝ නැති වූ ගමන් බලපත්‍ර police සහ Immigration Department වෙත වහාම වාර්තා කළ යුතුය.",
        "ta": "சேதமடைந்த அல்லது தொலைந்த கடவுச்சீடுகளை உடனடியாக police மற்றும் Immigration Department க்கு தெரிவிக்க வேண்டும்."
      }
    ],
  ...
  },
  {
    ...
    "requiredDocuments": [
      {
        "en": "Birth Certificate (original)",
        "si": "උපතේ සහතිකය (මුල්)",
        "ta": "பிறப்பு சான்றிதழ் (அசல்)"
      },
      {
        "en": "Parent's NIC copy (for first-time applicants under 18)",
        "si": "දෙමාපියන්ගේ NIC පිටපත (18 ට අඩු පළමු වරට අයදුම්කරුවන් සඳහා)",
        "ta": "பெற்றோரின் NIC நகல் (18க்கு கீழ் முதல் முறை விண்ணப்பதாரர்களுக்கு)"
      },
      {
        "en": "Previous NIC (for renewal/replacement)",
        "si": "පෙර NIC (අලුත් කිරීම/ප්‍රතිස්ථාපනය සඳහා)",
        "ta": "முந்தைய NIC (புதுப்பிப்பு/மாற்றீட்டுக்கு)"
      },
      {
        "en": "Police report (for lost NIC)",
        "si": "පolicereport (නැති වූ NIC සඳහා)",
        "ta": "Police report (தொலைந்த NIC க்கு)"
      },
      {
        "en": "Marriage certificate (if name changed)",
        "si": "විවාහ සහතිකය (නම වෙනස් නම්)",
        "ta": "திருமண சான்றிதழ் (பெயர் மாற்றம் இருந்தால்)"
      }
    ],
    "steps": [
      {
        "title": {
          "en": "Visit DRP Office",
          "si": "DRP කාර්යාලයට පිවිසෙන්න",
          "ta": "DRP அலுவலகத்திற்கு செல்லவும்"
        },
        "description": {
    ...
    "importantNotes": [
      {
        "en": "NIC is mandatory for opening bank accounts, voting, and most government transactions.",
        "si": "NIC බැංකු ගිණුම් විවෘත කිරීම, ඡන්දය සහ බොහෝ government ගනුදෙනු සඳහා අනivatory.",
        "ta": "NIC வங்கி கணக்குகள் திறப்பு, வாக்களிப்பு மற்றும் பெரும்பாலான government பரிவர்த்தனைகளுக்கு கட்டாயம்."
      },
      {
        "en": "Always carry your NIC when visiting government offices.",
        "si": "government කාර්යාලවලට පිවිසෙන විට සැමවිටම NIC රැගෙන යන්න.",
        "ta": "government அலுவலகங்களுக்கு செல்லும்போது எப்போதும் NIC ஐ எடுத்துச் செல்லவும்."
      }
    ],
  ...
  },
  {
    ...
    "requiredDocuments": [
      ...
      {
        "en": "Medical certificate from a registered medical practitioner",
        "si": "ලියාපදිංචි medical practitioner කෙනෙකුගෙන් medical certificate",
        "ta": "பதிவு செய்யப்பட்ட medical practitioner இலிருந்து medical certificate"
      },
      {
        "en": "Passport-size photographs (4 copies)",
        "si": "Passport-size ඡායාරූප (4 copies)",
        "ta": "Passport-size புகைப்படங்கள் (4 copies)"
      },
      {
        "en": "Previous driving licence (for renewal)",
        "si": "පෙර රියදුරු බලපත්‍රය (අලුත් කිරීම සඳහා)",
        "ta": "முந்தைய ஓட்டுநர் உரிமம் (புதுப்பிப்புக்கு)"
      }
    ],
    "steps": [
      {
        "title": {
          "en": "Apply at DMT Office",
          "si": "DMT කාර්යාලයේ අයදුම් කරන්න",
          "ta": "DMT அலுவலகத்தில் விண்ணப்பிக்கவும்"
        },
        "description": {
      ...
      {
        "title": {
          "en": "Pass Written Exam",
          "si": "Written Exam Pass කරන්න",
          "ta": "Written Exam Pass செய்யவும்"
        },
        "description": {
      ...
      },
      {
        "title": {
          ...
          "si": "Training සම්පූර්ණ කරන්න",
          "ta": "Training முடிக்கவும்"
        },
        "description": {
      ...
      {
        "title": {
          "en": "Pass Practical Test",
          "si": "Practical Test Pass කරන්න",
          "ta": "Practical Test Pass செய்யவும்"
        },
        "description": {
    ...
    "importantNotes": [
      {
        "en": "Minimum age for a car licence (Class B) is 18 years.",
        "si": "Car licence (Class B) සඳහා minimum age වයස 18.",
        "ta": "Car licence (Class B) க்கு minimum age 18 வயது."
      },
      {
        "en": "International driving permit can be obtained from AA Ceylon with a valid SL licence.",
        "si": "International driving permit valid SL licence සමඟ AA Ceylon වෙතින් ලබා ගත හැක.",
        "ta": "International driving permit valid SL licence உடன் AA Ceylon இலிருந்து பெறலாம்."
      }
    ],
  ...
  },
  {
    ...
    "requiredDocuments": [
      {
        "en": "Hospital birth notification (Form B1)",
        "si": "Hospital birth notification (Form B1)",
        "ta": "Hospital birth notification (Form B1)"
      },
      {
        "en": "Parents' NIC copies",
        "si": "දෙමාපියන්ගේ NIC copies",
        "ta": "பெற்றோரின் NIC copies"
      },
      {
        "en": "Parents' marriage certificate (if applicable)",
        "si": "දෙමාපියන්ගේ marriage certificate (අදාළ නම්)",
        "ta": "பெற்றோரின் marriage certificate (பொருந்தினால்)"
      },
      {
        "en": "Application form for certified copy",
        "si": "Certified copy සඳහා application form",
        "ta": "Certified copy க்கு application form"
      }
    ],
    "steps": [
      {
        "title": {
          "en": "Register Birth",
          "si": "උපත ලියාපදිංචි කරන්න",
          "ta": "பிறப்பு பதிவு செய்யவும்"
        },
        "description": {
      ...
      },
      {
        "title": {
          ...
          "si": "Certified Copy අයදුම් කරන්න",
          "ta": "Certified Copy விண்ணப்பிக்கவும்"
        },
        "description": {
    ...
    "importantNotes": [
      {
        "en": "Late registration (after 14 days) requires additional documentation and approval.",
        "si": "Late registration (14 days පසු) additional documentation සහ approval අවශ්‍ය.",
        "ta": "Late registration (14 நாட்களுக்குப் பிறகு) additional documentation மற்றும் approval தேவை."
      },
      {
        "en": "Birth certificate is required for school admission, passport, and NIC applications.",
        "si": "Birth certificate school admission, passport සහ NIC applications සඳහා අවශ්‍ය.",
        "ta": "Birth certificate பள்ளி admission, passport மற்றும் NIC applications க்கு தேவை."
      }
    ],
    "officialLink": "https://www.drp.gov.lk",
    "keywords": [
  ...
  },
  {
    ...
    "requiredDocuments": [
      {
        "en": "NIC copies of both parties",
        "si": "පාර්ties දෙදෙනාගේ NIC copies",
        "ta": "இரு parties NIC copies"
      },
      {
        "en": "Birth certificates of both parties",
        "si": "පාර්ties දෙදෙනාගේ birth certificates",
        "ta": "இரு parties birth certificates"
      },
      {
        "en": "Affidavit of unmarried status (if applicable)",
        "si": "Unmarried status affidavit (අදාළ නම්)",
        "ta": "Unmarried status affidavit (பொருந்தினால்)"
      },
      {
        "en": "Divorce decree (if previously married)",
        "si": "Divorce decree (පෙර විවාහ වූ නම්)",
        "ta": "Divorce decree (முன்பு திருமணமானிருந்தால்)"
      },
      {
        "en": "Two witnesses with NIC",
        "si": "NIC සහිත witnesses දෙදෙනෙක්",
        "ta": "NIC உடன் witnesses இருவர்"
      }
    ],
    "steps": [
      {
        "title": {
          "en": "Give Notice of Marriage",
          "si": "Give Notice of Marriage",
          "ta": "Give Notice of Marriage"
        },
        "description": {
      ...
      {
        "title": {
          "en": "Marriage Ceremony & Registration",
          "si": "Marriage Ceremony & Registration",
          "ta": "Marriage Ceremony & Registration"
        },
        "description": {
      ...
      {
        "title": {
          "en": "Obtain Certificate",
          "si": "Certificate ලබා ගන්න",
          "ta": "Certificate பெறவும்"
        },
        "description": {
    ...
    "importantNotes": [
      {
        "en": "Minimum legal age for marriage is 18 years for both parties.",
        "si": "Legal marriage age පාර්ties දෙදෙනාටම වයස 18.",
        "ta": "Legal marriage age இரு parties க்கும் 18 வயது."
      },
      {
        "en": "Marriage certificate is required for visa applications and name changes on NIC.",
        "si": "Marriage certificate visa applications සහ NIC name changes සඳහා අවශ්‍ය.",
        "ta": "Marriage certificate visa applications மற்றும் NIC name changes க்கு தேவை."
      }
    ],
  ...
  },
  {
    ...
    "requiredDocuments": [
      {
        "en": "Medical certificate of cause of death (Form B2)",
        "si": "Medical certificate of cause of death (Form B2)",
        "ta": "Medical certificate of cause of death (Form B2)"
      },
      {
        "en": "NIC of the deceased",
        "si": "Deceased NIC",
        "ta": "Deceased NIC"
      },
      {
        "en": "NIC of the informant (relative)",
        "si": "Informant (relative) NIC",
        "ta": "Informant (relative) NIC"
      },
      {
        "en": "Birth certificate of deceased (if available)",
        "si": "Deceased birth certificate (ලබා ගත හැකි නම්)",
        "ta": "Deceased birth certificate (கிடைத்தால்)"
      }
    ],
    "steps": [
      {
        "title": {
          "en": "Obtain Medical Certificate",
          "si": "Medical Certificate ලබා ගන්න",
          "ta": "Medical Certificate பெறவும்"
        },
        "description": {
      ...
      {
        "title": {
          "en": "Register at Registrar Office",
          "si": "Registrar කාර්යාලයේ ලියාපදිංචි",
          "ta": "Registrar அலுவலகத்தில் பதிவு"
        },
        "description": {
      ...
      {
        "title": {
          "en": "Collect Death Certificate",
          "si": "Death Certificate ලබා ගන්න",
          "ta": "Death Certificate பெறவும்"
        },
        "description": {
    ...
    "importantNotes": [
      {
        "en": "Registration is mandatory before cremation or burial permits are issued.",
        "si": "Cremation හෝ burial permits නිකුත් කිරීමට පෙර registration mandatory.",
        "ta": "Cremation அல்லது burial permits வழங்குவதற்கு முன் registration கட்டாயம்."
      },
      {
        "en": "Multiple certified copies may be needed for banks, insurance, and property matters.",
        "si": "Banks, insurance සහ property matters සඳහා multiple certified copies අවශ්‍ය විය හැක.",
        "ta": "Banks, insurance மற்றும் property matters க்கு multiple certified copies தேவைப்படலாம்."
      }
    ],
    "officialLink": "https://www.rgd.gov.lk",
    "keywords": [
  ...
  },
  {
    ...
    "requiredDocuments": [
      {
        "en": "NIC copies of owner(s)/directors",
        "si": "Owner(s)/directors NIC copies",
        "ta": "Owner(s)/directors NIC copies"
      },
      {
        "en": "Business name search approval",
        "si": "Business name search approval",
        "ta": "Business name search approval"
      },
      {
        "en": "Articles of Association (for companies)",
        "si": "Articles of Association (companies සඳහා)",
        "ta": "Articles of Association (companies க்கு)"
      },
      {
        "en": "Form 1 and Form 18 (for private limited companies)",
        "si": "Form 1 සහ Form 18 (private limited companies)",
        "ta": "Form 1 மற்றும் Form 18 (private limited companies)"
      },
      {
        "en": "Registered office address proof",
        "si": "Registered office address proof",
        "ta": "Registered office address proof"
      }
    ],
    "steps": [
      {
        "title": {
          "en": "Name Search & Reservation",
          "si": "Name Search & Reservation",
          "ta": "Name Search & Reservation"
        },
        "description": {
      ...
      },
      {
        "title": {
          ...
          "si": "Documents සකස් කරන්න",
          "ta": "Documents தயார் செய்யவும்"
        },
        "description": {
      ...
      },
      {
        "title": {
          ...
          "si": "Registration ඉදිරිපත් කරන්න",
          "ta": "Registration சமர்ப்பிக்கவும்"
        },
        "description": {
    ...
    "importantNotes": [
      {
        "en": "After registration, obtain a TIN from the Inland Revenue Department for tax purposes.",
        "si": "Registration පසු tax purposes සඳහා Inland Revenue Department වෙතින් TIN ලබා ගන්න.",
        "ta": "Registration பிறகு tax purposes க்கு Inland Revenue Department இலிருந்து TIN பெறவும்."
      },
      {
        "en": "Annual returns must be filed with the ROC to maintain active status.",
        "si": "Active status පවත්වා ගැනීමට ROC වෙත annual returns file කළ යුතුය.",
        "ta": "Active status பராமரிக்க ROC க்கு annual returns file செய்ய வேண்டும்."
      }
    ],
  ...
  },
  {
    ...
    "requiredDocuments": [
      {
        "en": "NIC or Business Registration Certificate",
        "si": "NIC හෝ Business Registration Certificate",
        "ta": "NIC அல்லது Business Registration Certificate"
      },
      {
        "en": "Proof of address",
        "si": "Address proof",
      ...
      },
      {
        ...
        "ta": "Bank account details"
      },
      {
        "en": "Financial statements (for VAT registration)",
        "si": "Financial statements (VAT registration)",
        "ta": "Financial statements (VAT registration)"
      }
    ],
    "steps": [
      {
        "title": {
          "en": "Register on IRD Portal",
          "si": "IRD Portal එකේ Register",
          "ta": "IRD Portal இல் Register"
        },
        "description": {
      ...
      {
        "title": {
          "en": "VAT Registration (if applicable)",
          "si": "VAT Registration (අදාළ නම්)",
          "ta": "VAT Registration (பொருந்தினால்)"
        },
        "description": {
      ...
      {
        "title": {
          "en": "Receive TIN Certificate",
          "si": "TIN Certificate ලබා ගන්න",
          "ta": "TIN Certificate பெறவும்"
        },
        "description": {
    ...
    "importantNotes": [
      {
        "en": "File annual tax returns before November 30 each year.",
        "si": "Annual tax returns සෑම වසරකම November 30ට පෙර file කරන්න.",
        "ta": "Annual tax returns ஒவ்வொரு வருடமும் November 30க்கு முன் file செய்யவும்."
      },
      {
        "en": "Keep all receipts and financial records for at least 6 years.",
        "si": "Receipts සහ financial records අවම වශයෙන් වසර 6ක් තබා ගන්න.",
        "ta": "Receipts மற்றும் financial records குறைந்தது 6 வருடங்கள் வைத்திருக்கவும்."
      }
    ],
  ...
  },
  {
    ...
    "requiredDocuments": [
      {
        "en": "National Identity Card (NIC) — required for most services",
        "si": "NIC — බොහෝ services සඳහා අවශ්‍ය",
        "ta": "NIC — பெரும்பாலான services க்கு தேவை"
      },
      {
        "en": "Relevant application forms (available on respective department websites)",
        "si": "Relevant application forms (department websites)",
        "ta": "Relevant application forms (department websites)"
      },
      {
        "en": "Supporting documents as specified by each service",
        "si": "Supporting documents (service අනුව)",
        "ta": "Supporting documents (service படி)"
      }
    ],
    "steps": [
      {
        "title": {
          "en": "Visit Gov.lk Portal",
          "si": "Gov.lk Portal වෙත පිවිසෙන්න",
          "ta": "Gov.lk Portal க்கு செல்லவும்"
        },
        "description": {
      ...
      {
        "title": {
          "en": "Contact Grama Niladhari",
          "si": "Grama Niladhari සම්බන්ධ වන්න",
          "ta": "Grama Niladhari தொடர்பு கொள்ளவும்"
        },
        "description": {
      ...
      {
        "title": {
          "en": "Use Divisional Secretariat",
          "si": "Divisional Secretariat භාවිතා කරන්න",
          "ta": "Divisional Secretariat பயன்படுத்தவும்"
        },
        "description": {
      ...
      {
        "title": {
          "en": "Call 1919 Hotline",
          "si": "1919 Hotline අමතන්න",
          "ta": "1919 Hotline அழைக்கவும்"
        },
        "description": {
    ...
    "importantNotes": [
      {
        "en": "Always verify information on official government websites before applying.",
        "si": "Apply කිරීමට පෙර official government websites වල information verify කරන්න.",
        "ta": "Apply செய்வதற்கு முன் official government websites இல் information verify செய்யவும்."
      },
      {
        "en": "Beware of unauthorized agents charging excessive fees for government services.",
        "si": "Unauthorized agents excessive fees ගැනීමෙන් ප්‍රවේශම් වන්න.",
        "ta": "Unauthorized agents excessive fees வசூலிப்பதை beware."
      }
    ],
